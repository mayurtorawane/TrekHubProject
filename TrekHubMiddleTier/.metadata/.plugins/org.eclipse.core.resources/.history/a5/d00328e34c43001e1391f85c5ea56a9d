...
public class PlanTrekDummy 
{
	...
	public PlanTrekDummy(Date start_date, Date end_date, double price, int avail_seats, Date last_date_apply,
	...
	public String toString() {
		return "PlanTrekDummy [start_date=" + start_date + ", end_date=" + end_date + ", price=" + price
				+ ", avail_seats=" + avail_seats + ", last_date_apply=" + last_date_apply + ", trek_id=" + trek_id
				+ ", guide_id=" + guide_id + ", status=" + status + "]";
	}
